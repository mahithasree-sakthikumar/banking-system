        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
               <ul class="navbar-nav mr-auto">
                   <li class="nav-item active"><a class="nav-link" href="index.php"><i class="fa fa-home"></i> bank</a></li>
                   <li class="nav-item"><a class="nav-link" href="viewusers.php"><i class="fa fa-info" aria-hidden="true"></i> view users</a></li>
        ...
        <div class="container">
            <div class="row">             
                ...
                <div class="col-7 col-sm-5">
                    <h5>Our Address</h5>
                    <address>
                        hiranandani mumbai<br>
                          maharashtra<br>
		              <i class="fa fa-phone-square" aria-hidden="true"></i> : +567438729<br>
		              <i class="fa fa-fax" aria-hidden="true"></i> : + 1234567<br>
		              <i class="fa fa-envelope" aria-hidden="true"></i> : <a href="mailto:donatelyme@gmail.com">sparksfoundation.net</a>
		           </address>
                </div>
           ...
           <div class="row justify-content-center">             
                <div class="col-auto">
                    <p>© Copyright 2020 sparksfoundation</p>
                </div>
           </div>
        </div>
    </footer>
